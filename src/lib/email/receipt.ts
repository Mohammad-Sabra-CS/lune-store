...
<body style="margin:0;padding:0;background:#f6f2e9;font-family:Georgia,'Times New Roman',serif;">
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    <div style="background:#0b0e17;padding:32px;text-align:center;">
      <p style="margin:0;color:#c4a15e;font-size:26px;letter-spacing:6px;text-transform:uppercase;">Lune</p>
      <p style="margin:8px 0 0;color:#f4eedf99;font-size:12px;letter-spacing:2px;">${t.motto}</p>
    </div>
    <div style="background:#fbf8f1;padding:32px;text-align:${t.align};">
      <h1 style="margin:0 0 8px;color:#0b0e17;font-size:22px;font-weight:normal;">${t.title}</h1>
      ...
      <table style="width:100%;border-collapse:collapse;font-size:14px;" dir="${t.dir}">
        <thead>
          <tr>
            <th style="text-align:${t.align};padding-bottom:8px;border-bottom:2px solid #0b0e17;color:#0b0e17;font-weight:normal;font-size:12px;text-transform:uppercase;letter-spacing:1px;">${t.item}</th>
            <th style="text-align:center;padding-bottom:8px;border-bottom:2px solid #0b0e17;color:#0b0e17;font-weight:normal;font-size:12px;text-transform:uppercase;letter-spacing:1px;">${t.qty}</th>
            <th style="text-align:${t.dir === "rtl" ? "left" : "right"};padding-bottom:8px;border-bottom:2px solid #0b0e17;color:#0b0e17;font-weight:normal;font-size:12px;text-transform:uppercase;letter-spacing:1px;">${t.price}</th>
          </tr>
        </thead>
        <tbody>${rows}</tbody>
      </table>
      <table style="width:100%;border-collapse:collapse;font-size:14px;margin-top:16px;" dir="${t.dir}">
        <tr>
          ...
          <td style="padding:4px 0;text-align:${t.dir === "rtl" ? "left" : "right"};color:#0b0e17;">${order.subtotal} ${t.currency}</td>
        </tr>
        <tr>
          <td style="padding:4px 0;color:#6b6553;">${t.delivery}</td>
          <td style="padding:4px 0;text-align:${t.dir === "rtl" ? "left" : "right"};color:#0b0e17;">${order.deliveryFee} ${t.currency}</td>
        </tr>
        <tr>
          <td style="padding:12px 0 0;color:#0b0e17;font-size:16px;"><strong>${t.total}</strong></td>
          <td style="padding:12px 0 0;text-align:${t.dir === "rtl" ? "left" : "right"};color:#0b0e17;font-size:16px;"><strong>${order.total} ${t.currency}</strong></td>
        </tr>
      </table>
